...
const fetchAllReportIngredients = async ({
  take,
  skip,
  search,
  startDate,
  ...
  const result = await axios.get(
    process.env.NEXT_PUBLIC_API_URL + "/api/report/ingredients/all",
    {
      params: {
        take,
        skip,
...
const ReportIngredientPage = async (props: ServerProps) => {
  ...
  const dataReports = await fetchAllReportIngredients({
    skip: skip,
    take: take,
  ...
  return (
    <div className="w-full space-y-4">
      <div className="w-full flex flex-col-reverse lg:flex-row items-center justify-between gap-2">
        ...
        <div>
          <Link href={"/dashboard/report/ingredient/create"}>
...
export default ReportIngredientPage;
